...
<html class="fixed">
	<head>
        ...
        <!-- Vendor CSS -->
        <link rel="stylesheet" href="{{asset('admin/assets/vendor/jquery-ui/css/jquery-ui-1.10.4.custom.css')}}"/>
	...
	<body>
        ...
        <script src="{{asset('admin/assets/vendor/jquery-ui/js/jquery-ui-1.10.0.custom.js')}}"></script> --}}
